  ...
  return (
    <main className="admin-shell">
      ...
      <p className="muted" style={{ marginTop: 0 }}>
        Primary product on records.core64.studio — upload → QC → TP master → download.
      </p>
      <p className="muted">
      ...
      <p className="muted" style={{ marginTop: "0.35rem" }}>
        Retention: job files (uploads, output.wav, qc.json) are deleted automatically after 24
        hours.
      </p>
      <div className="nav">
            ...
            <tbody>
              ...
              {qc.probe ? (
                <tr>
                  <th>Probe</th>
                  <td>
                    {qc.probe.codec_name || "?"} / {qc.probe.sample_rate_hz || "?"} Hz / ch=
                    {qc.probe.channels ?? "?"}
